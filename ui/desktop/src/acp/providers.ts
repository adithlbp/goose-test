...
/**
 * Live model list from the provider's own endpoint (e.g. OpenAI `/v1/models`).
 * Unlike the inventory list, this is not gated by `dynamic_models`, so custom
 * providers return the models the gateway actually exposes.
 */
