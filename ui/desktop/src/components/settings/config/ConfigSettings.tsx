...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Edit your Genius Assistant configuration settings',
  },
  descriptionWithProvider: {
    id: 'configSettings.descriptionWithProvider',
    defaultMessage: 'Edit your Genius Assistant configuration settings (current settings for {provider})',
  },
  editConfiguration: {
