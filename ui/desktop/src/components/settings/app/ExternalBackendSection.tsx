...
const i18n = defineMessages({
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes apply to new chat windows. Restart Genius Assistant to update existing windows.',
  },
  urlProtocolError: {
  ...
  managedNotice: {
    id: 'externalBackendSection.managedNotice',
...
export default function ExternalBackendSection() {
  ...
  const isLockedByOrg = Boolean(window.appConfig?.get('GOOSE_LOCK_BACKEND'));
        ...
        <CardContent className="pt-4 space-y-4 px-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              {isLockedByOrg && (
                <p className="text-xs text-text-secondary max-w-md mt-[2px] italic">
            ...
            <div className="flex items-center">
              <Switch
                ...
                disabled={isSaving || isLockedByOrg}
                variant="mono"
              />
            </div>
          </div>
