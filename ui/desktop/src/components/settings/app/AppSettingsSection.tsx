...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how Genius Assistant appears on your system',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of Genius Assistant',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for Genius Assistant',
  },
  ...
  helpDesc: {
    ...
    defaultMessage:
      'Help us improve Genius Assistant by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep Genius Assistant running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select Genius Assistant in the application list',
  },
        ...
        <Card className="rounded-lg">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              <span className="text-2xl text-black dark:text-white">Genius Assistant</span>
