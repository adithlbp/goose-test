...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'Genius Assistant is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'Genius Assistant is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'Genius Assistant is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'Genius Assistant is compacting the conversation...',
  },
  idle: {
