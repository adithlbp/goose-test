...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using Genius Assistant.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve Genius Assistant. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
