...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Anonymous usage data helps us understand how Genius Assistant is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'Genius Assistant version and install method',
  },
  collectProvider: {
